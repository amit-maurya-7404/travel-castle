      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-slide-in-up relative z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center w-full max-w-md mx-auto">
          ...
          <Link href="#trips" className="w-full sm:w-auto flex-1">
            <Button size="lg" variant="outline" className="w-full border-white/30 text-white hover:bg-white/10 px-8 h-14 rounded-full font-bold shadow-lg transition-all hover:border-white">
              View Packages
            </Button>
          </Link>
        </div>
